...
export const updateSubmissionResult = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Error updating submission result', error: error.message });
  }
};
...
export const getAssignmentsWithSubmissions = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Error fetching assignments with submissions', error: error.message });
  }
};
...
export const getAssignmentsWithSubmissionsByAssignmentId = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Error fetching assignment with submissions', error: error.message });
  }
};